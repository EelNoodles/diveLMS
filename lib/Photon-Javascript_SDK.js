    ...
    var PhotonPeer = /** @class */ (function () {
        ...
        */
        PhotonPeer.prototype.connect = function (appid) {
            ...
            var url = "wss://ns.photonengine.io:19093" + "/" + appid + "?libversion=" + Photon.Version;
            if (this.subprotocol == "") {
        ...
        var LoadBalancingClient = /** @class */ (function () {
            ...
            */
            function LoadBalancingClient(protocol, appId, appVersion) {
                ...
                //------------------------
                this.connectionProtocol = 1; // protocol set in constructor, can be overriden by prefix in server address string
